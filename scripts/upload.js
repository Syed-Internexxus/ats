    ...
    ({ initializeApp }) => {
      ...
      import("https://www.gstatic.com/firebasejs/9.22.2/firebase-auth.js").then(
        ({ getAuth, signOut, onAuthStateChanged }) => {
          ...
          const jobDescSection = document.getElementById(
          ...
          submitButton.addEventListener("click", async () => {
            ...
            try {
              const response = await fetch(
                "https://x4n0kqckl9.execute-api.us-west-1.amazonaws.com/default/resume_ats_analyzer",
                {
                  method: "POST",
              ...
              alert("Resume analysis successful! Check the results.");
              // Redirect or display analysis results here
            } catch (error) {
